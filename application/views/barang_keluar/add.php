        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_keluar', date('d-m-Y')); ?>" name="tanggal_keluar" id="tanggal_keluar" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jenis">Tempat</label>
                    <div class="col-md-5">
                        <span class="input-group-text form-control" id="jenis"></span>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="costumer">Costumer</label>
                    <div class="col-md-5">
                        <div class="input-group">
                                <span class="input-group-text form-control" id="costumer"></span>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_barang">Total Stok</label>
                    <div class="col-md-5">
                        <input readonly="readonly" id="total_barang" type="number" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
