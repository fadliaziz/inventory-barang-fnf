        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('supplier'); ?>">
                    ...
                    <span>Data Supplier Vendor</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('costumer'); ?>">Costumer</a>
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan Barang</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Tempat</a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Inventory Barang &bull; by <?= anchor('https://www.instagram.com/flizoneye/', 'Fadli Aziz'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#barang_id', function() {
            ...
            $.getJSON(url, function(data) {
                ...
                costumer.html(data.nama_costumer);
                jenis.html(data.nama_jenis);
                stok.val(data.stok);
                total.val(data.stok);
                jumlah.focus();
            });
