        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_masuk',date('d-m-Y')); ?>" name="tanggal_masuk" id="tanggal_masuk" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_barang">Total</label>
                    <div class="col-md-5">
