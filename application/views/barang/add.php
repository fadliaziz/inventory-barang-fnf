    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="costumer_id">Nama costumer</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <select name="costumer_id" id="costumer_id" class="custom-select">
                                ...
                                <?php foreach ($costumer as $c) : ?>
                                    <option <?= set_select('costumer_id', $c['id_costumer']) ?> value="<?= $c['id_costumer'] ?>"><?= $c['nama_costumer'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                                <a class="btn btn-success" href="<?= base_url('costumer/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_barang'); ?>" name="nama_barang" id="nama_barang" type="text" class="form-control" placeholder="Jenis Barang...">
                        <?= form_error('nama_barang', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="tebal">Tebal</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('tebal'); ?>" name="tebal" id="tebal" type="number" class="form-control" placeholder="Tebal Barang...">
                        <?= form_error('tebal', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="tebal">Lebar</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('lebar'); ?>" name="lebar" id="lebar" type="number" class="form-control" placeholder="Lebar Barang...">
