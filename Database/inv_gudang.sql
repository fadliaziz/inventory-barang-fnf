...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2023 at 02:38 AM
...
CREATE TABLE `barang` (
  ...
  `tebal` varchar(6) NOT NULL,
  `lebar` varchar(6) NOT NULL,
...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `stok`, `tebal`, `lebar`, `satuan_id`, `jenis_id`, `costumer_id`) VALUES
('B000001', 'coba', 125, '144', '234', 5, 10, 2),
('B000002', 'JSC/H440W', 409, '123', '4', 5, 9, 2);
...
('T-BK-181023001', 14, 'B000001', 21, '2023-10-18'),
('T-BK-181023002', 14, 'B000002', 32, '2023-10-18');
...
('T-BM-181023001', 3, 14, 'B000001', 31, '2023-10-18'),
('T-BM-181023003', 2, 14, 'B000001', 21, '2023-10-18');
...
CREATE TABLE `costumer` (
  ...
  `nama_costumer` varchar(15) NOT NULL
...
(14, 'fadli', 'fadli', 'fadlijokam123@gmail.com', '085156478238', 'gudang', '$2y$10$mF6cry.hvUDHkmPPh1hAi.FXGRTxjI/ttPBi4qaupZJMvixf65imS', 1697012060, '4d2986b0d20647cf38c3eb0cc6a36c08.jpg', 1);
...
ALTER TABLE `barang`
  ...
  ADD CONSTRAINT `barang_ibfk_3` FOREIGN KEY (`costumer_id`) REFERENCES `costumer` (`id_costumer`) ON DELETE CASCADE ON UPDATE CASCADE;
